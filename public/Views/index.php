...
<ul class="am-pagination blog-pagination">
    ...
    <li class="am-pagination-prev">
        <a href="<?php echo isset($cat) ? "category/{$cat}.html":''; ?>?page=<?=$page['current'] - 1;?>">&laquo; 上一页</a>
    </li>
    <?php endif;?>
    <?php if ($page['current'] != $page['page_nums']): ?>
    <li class="am-pagination-next">
        <a href="<?php echo isset($cat) ? "category/{$cat}.html":''; ?>?page=<?=$page['current'] + 1;?>">下一页 &raquo;</a>
    </li>
    <?php endif;?>
</ul>